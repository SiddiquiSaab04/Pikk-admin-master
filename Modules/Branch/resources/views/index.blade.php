                ...
                <div class="form-group top_search">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-primary text-white" onclick="event.preventDefault(); window.location = '/branch/'+ (document.getElementById('search').value)">Go!</button>
                        </span>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $branch->phone }}</td>
                            <td>{{ $branch->multi_kitchen ? 'True' : 'False' }}</td>
                            ...
                            <td role="presentation" class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 44px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    ...
                                    <form id="delete" action="{{ route('branch.destroy', $branch->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
