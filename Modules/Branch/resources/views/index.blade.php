                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-primary text-white"
                                    onclick="event.preventDefault(); window.location = '/branch/'+ (document.getElementById('search').value)">Go!</button>
                            </span>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td role="presentation" class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                            ...
                                            <form id="delete" action="{{ route('branch.destroy', $branch->id) }}"
                                                method="post">
                                                @csrf
                                                @method('DELETE')
                                            </form>
