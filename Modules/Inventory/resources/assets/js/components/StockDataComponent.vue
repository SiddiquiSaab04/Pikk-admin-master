<template>
  <tr>
    ...
    <td class="border">
      <div class="btn-group btn-group-toggle">
        <label class="btn btn-success btn-sm" :class="{ active: is_new == 1 }">
          <input
            type="radio"
            v-model="is_new"
            value="1"
        ...
        <label class="btn btn-danger btn-sm" :class="{ active: is_new == 0 }">
          <input
            type="radio"
            v-model="is_new"
            value="0"
  ...
  data() {
    return {
      ...
      default_quantity: this.product.stock
        ...
        : null,
      is_enabled: this.product.stock ? this.product.stock.is_enabled : null,
      is_new: this.product.stock ? this.product.stock.is_new : null,
    };
  },
  methods: {
    save() {
