<template>
    <div class="row">
        <div class="col-sm-4">
            ...
            <span class="mt-1">
                <p class="mt-1">Enter addon group for the product.</p>
            </span>
        </div>
        <div class="col-sm-2">
            <p class="mb-0">
        ...
        <div class="col-sm-6" v-if="Object.keys(selectedAddon).length > 1">
            ...
            <span class="mt-1">
                <p class="mt-1">
                    Select products which you want to add as modifiers
                </p>
            </span>
        ...
        <div class="col-sm-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Manage Addons</h2>
                    <ul
                        class="nav navbar-right panel_toolbox justify-content-end"
                    >
                        <li>
                ...
                <div class="x_content">
                    <table class="table table-hover">
                        ...
                        <tbody id="addonBody">
                            <tr
                                v-for="(addon, key) in selectedAddons"
                                :key="key"
                            >
                                <td>{{ key + 1 }}</td>
                                <td>{{ addon.name }}</td>
                                ...
                                <td>
                                    <a
                                        ...
                                        @click="deleteEntry(addon.id)"
                                    >
                                        <i
                                            class="fa fa-trash-o text-danger text-lg"
                                        ></i>
                                    </a>
                                </td>
                            </tr>
        ...
        addToForm() {
            ...
            if (
                this.selectedAddons.find(
                    (addon) => addon.id == this.selectedAddon.id
                )
            ) {
