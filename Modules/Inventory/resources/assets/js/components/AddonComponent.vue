<template>
  <div class="row">
    ...
    <div class="col-sm-2">
      ...
      <span class="mt-1">
        <p class="mt-1">The specific group is required or not</p>
      </span>
    </div>
    <div class="col-sm-2">
      <p class="mb-0">
    ...
    <div class="col-sm-4" v-if="Object.keys(selectedAddon).length > 1">
      <p class="mb-0">
          ...
          <table class="table table-hover">
            ...
            <tbody id="addonBody">
              <tr v-for="(addon, key) in selectedAddons" :key="key">
                ...
                <td>{{ addon.required == "1" ? "True" : "False" }}</td>
                <td>
                  <ul>
                    <li
...
export default {
  ...
  methods: {
    ...
    addToForm() {
      ...
      this.selectedAddon.required = this.required
      if (
